...
namespace Yuki::Vulkan {
	...
	inline void Enumerate(TEnumeratorFunc&& enumeratorFunc, DynamicArray<TVulkanType>& array, TFuncArgs&&... args)
	{
		uint32_t numElements = 0;
		enumeratorFunc(std::forward<TFuncArgs>(args)..., &numElements, nullptr);
		array.resize(static_cast<size_t>(numElements));
		enumeratorFunc(std::forward<TFuncArgs>(args)..., &numElements, array.data());
	}
