...
namespace Yuki {
	...
	public:
		...
		VkBuffer CreateBuffer(BufferType InBufferType, const VkBufferCreateInfo* InCreateInfo, VmaAllocation* OutAllocation, std::source_location location = std::source_location::current());
