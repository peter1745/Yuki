...
namespace Yuki {
	...
	public:
		...
		size_t GetCount() const { return m_ElementCount; }
	...
	private:
		void InsertNewPage(size_t InPageIndex)
		{
			if (m_ElementCount < m_Capacity)
				return;
			...
			m_PageTable[InPageIndex] = newPage;
			m_Capacity += PageSize;
		}
